      ...
      <Section>
        ...
        {chartInfoOpen?(
          <div style={{background:C.card2,borderLeft:"3px solid "+C.blue,padding:"11px 13px",marginBottom:14,fontSize:11,color:C.muted2,lineHeight:1.7}}>
            ...
            This matters when you rotate rep ranges across mesos. If you ran 185×10 in a hypertrophy meso and then 225×4 in a strength-focused meso, raw weight alone makes it look like a massive jump — but that jump is partly just the lower reps allowing a heavier load. e1RM accounts for both weight and reps, so the chart reflects <strong style={{color:C.muted2}}>actual strength change</strong> regardless of how many reps you were doing.<br/><br/>
...
export default function App(){
  ...
  return(
    ...
    <div style={{fontFamily:"'Inter',sans-serif",background:C.bg,color:C.text,height:"100dvh",maxWidth:480,margin:"0 auto",display:"flex",flexDirection:"column",position:"relative",transition:"background .25s,color .25s",overflow:"hidden"}} ref={el=>{if(el) el.style.height='-webkit-fill-available';}}>
      ...
      <div className="hyper-nav" style={{background:C.surf,borderTop:"1px solid "+C.border+"60",display:"flex",flexShrink:0,paddingBottom:"max(env(safe-area-inset-bottom), 0px)",marginTop:"auto",marginBottom:0}}>
        {TABS.map(t=>{
